<?php 
  $nama = "Muh. Farhan";
  $type = "Student";
  $birthday = "19 Mei 2003";
  $phone = "08123456789";
  $city = "Makassar";
  $age = 20;
  $website = "www.farhan.com";
  $email = "emailfarhan@mail.com";
?>
...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.php"><?= $nama ?></a></h1>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1><?= $nama ?></h1>
      <p>I'm <span class="typed" data-typed-items=<?=$type?>></span></p>
    </div>
  </section><!-- End Hero -->
